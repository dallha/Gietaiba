  ...
  const users: (UserSession & { passwordHash: string })[] = [
    {
      ...
      role: 'SUPER_ADMIN',
      phone: '+221 77 600 00 01',
      passwordHash: 'admin123',
    },
    {
      id: 'usr-direction',
      email: 'direction@taiba-voyages.sn',
      displayName: 'Mme Khady Diop (Directrice Générale)',
      role: 'DIRECTION',
      phone: '+221 77 600 00 02',
      passwordHash: 'dir123',
    },
    {
      id: 'usr-caisse',
      email: 'caisse@taiba-voyages.sn',
      displayName: 'Cheikh Tidiane Wade (Responsable Caisse)',
      role: 'CAISSE',
      phone: '+221 77 600 00 03',
    ...
    },
    {
      ...
      role: 'AGENT',
      phone: '+221 77 600 00 04',
      passwordHash: 'agent123',
    },
    {
      id: 'usr-logistique',
      email: 'logistique@taiba-voyages.sn',
      displayName: 'Ousmane Ndiaye (Chef Logistique & Vols)',
      role: 'LOGISTIQUE',
      phone: '+221 77 600 00 05',
      passwordHash: 'log123',
    },
    {
  ...
  const voyages: Voyage[] = [
    {
      ...
      responsable: 'El Hadj Amadou Niang (Chef de Mission)',
      responsablePhone: '+221 77 600 00 01',
    ...
    },
    {
      ...
      responsable: 'Cheikh Tidiane Wade (Guide Spirituel)',
      responsablePhone: '+221 77 600 00 03',
  ...
  const audit_logs: AuditLog[] = [
    {
      id: 'log-001',
      userId: 'usr-admin',
      userName: 'El Hadj Amadou Niang',
      action: 'INITIALISATION_SYSTEME',
      entity: 'DATABASE',
      entityId: 'SYSTEM',
      newValue: 'Initialisation de GIE VOYAGE ERP V4 avec les 6 pèlerins Hajj 2027',
      timestamp: now,
    },
    {
      id: 'log-002',
