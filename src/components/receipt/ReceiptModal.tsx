...
export const ReceiptModal: React.FC<ReceiptModalProps> = ({
  ...
  return (
    <div id="receipt-modal-backdrop" className="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/60 backdrop-blur-xs p-2 sm:p-4 overflow-y-auto">
      <div className="bg-white rounded-xl shadow-2xl max-w-2xl w-full border border-slate-200 overflow-hidden my-4 sm:my-8 print:my-0 print:border-none print:shadow-none print:max-w-full print:w-full print:rounded-none">
        {/* Actions bar (non-printable) */}
        <div className="flex items-center justify-between px-3 sm:px-6 py-3 sm:py-4 bg-slate-900 text-white print:hidden">
        ...
        {/* The Formal Document */}
        <div ref={receiptRef} className="p-4 sm:p-8 md:p-10 bg-white text-slate-900 print:p-0">
          {/* Header */}
